<?php
	...
	$sql1 = "SELECT * FROM member where mobile = '".$_GET['mobChoi']."'";
	...
	$reservationDatetime = $_GET["datetimeChoi"];
	$content = $_GET['conChoi'];
	$fk_reservation_doctorINDEX = 10004;
	$fk_reservation_memberINDEX = $memberINDEX;
	$fk_reservation_mobile = $_GET["mobChoi"];
